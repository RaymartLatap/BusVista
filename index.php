...
<a class="navbar-brand" href="index.html">B<span class="themecolor">u</span>sVista</a>    
</div>        
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
<ul class="nav navbar-nav navbar-right">       
<li><a href="#home" class="page-scroll"><h3>Home</h3></a></li>                                        
<li><a href="#one" class="page-scroll"><h3>About Us</h3></a></li>                               
...
<h1 class="main-heading-title"><span class="main-element themecolor" data-elements=" Welcome to BusVista"></span></h1>
<p class="main-heading-text"><br>Welcome to BusVista, where provincial bus travel is transformed into a seamless adventure. Our user-friendly interface<br> and cutting-edge reservation system ensure effortless journeys, while our unwavering dedication to passenger safety and comfort sets us apart.</p> 
<div class="btn-bar">       
...
<p class="a-slog">BusVista redefines provincial bus travel through its user-friendly interface, advanced reservation system, and unwavering commitment to safety, seamlessly connecting passengers to scenic destinations while prioritizing comfort and convenience.</p>           
</div>        
</div>        
<div class="gap">         
</div>        
